...
1. **Carregamento**: arquivos canônicos (`_principles.md`, `_glossary.md`, `_self_check.md`) e específicos (`ARCHITECTURE.md`, `traceability/spec-impact.md`, etc.) estão lidos?
...
4. **Blast radius (C8)**: a ação proposta consultou `traceability/spec-impact.md`? Sumário explicita o blast radius previsto?
