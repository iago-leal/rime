...
| `prompt` | mudança em prompt registry (`docs/prompts/` ou `.skills/`) — herdado do rime-v5 |
...
- **Refs**: lista separada por vírgula. Aceita prefixos `ADR-NNNN`, `#issue`, `PR #M`, `registro/sessoes/<arquivo>.md`, `docs/postmortems/<arquivo>.md`.
...
Refs: ADR-0042, #189, registro/sessoes/2026-05-05.md
```
...
Refs: registro/sessoes/2026-05-06.md
```
